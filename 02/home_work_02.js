...
let num1 = parseFloat(prompt("Введите первое число:"));                                 // Запросить у пользователя два числа
...
let summa = parseFloat(prompt("Введите сумму:"));                                       // Значение валюты

const rate = 37.5;                                                                      // Курс

let resultate = summa * rate;                                                              // Обчисление
result = result.toFixed(2);                                                             // Ограничение знаков после запятой

alert("Результат обміну: " + result);                                                   // Вивести результат

//--------------------------Цвет------------------------------------------------------------------//

let red = parseInt(prompt("Введите значение для red (от 0 до 255):"));
let green = parseInt(prompt("Введите значение для green (от 0 до 255):"));              // Запросить ввести значения для red, green и blue
let blue = parseInt(prompt("Введите значение для blue (от 0 до 255):"));
...
let totalFloors = parseInt(prompt("Введите количество этажей в доме:"));                // Вводим кл-во этажей и квартир на этаже
let flatsPerFloor = parseInt(prompt("Введите количество квартир на этаже:"));

let flatNumber = parseInt(prompt("Введите номер квартиры:"));                           // Получение номера квартиры от пользователя
